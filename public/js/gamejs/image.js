 ...
 */
exports.load = function(key, tileSize, xpos, ypos) {
   var img;
   ...
   var surface = null;
   if(tileSize != null && xpos != null && ypos != null)
   { 
		surface = new gamejs.Surface([tileSize, tileSize]);
		canvas.width = tileSize;
		canvas.height = tileSize;
		var sx = xpos * tileSize;
		var sy = ypos * tileSize;
		var s = tileSize;
		context.drawImage(img,sx,sy,s,s,0,0,s,s);
   } else {
		surface = new gamejs.Surface([img.naturalWidth, img.naturalHeight]);
